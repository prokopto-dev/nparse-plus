...
live since 1.18 and serving an empty schema-1 index; Browse degrades to
"Registry unavailable" on any fetch failure). `core/driver.py` grew `add_supervised_tick`: plugin ticks are
