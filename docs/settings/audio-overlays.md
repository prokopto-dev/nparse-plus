...
Everything on this page applies as soon as you hit Apply — no restart. The
voice change reaches handlers that are already running, and the two durations
take effect on the next alert and the next lane.
