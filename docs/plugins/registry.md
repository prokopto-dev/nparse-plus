...
!!! note "Status"
    The registry **repository is not live yet**, so the Browse dialog shows
    "Registry unavailable" and everything else (file/URL installs, the
    plugins folder) works normally.
